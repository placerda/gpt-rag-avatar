...
# Configure the orchestrator endpoint and function key from environment variables.
...
# Place your index.html, CSS, JavaScript, and images inside the 'static' folder.
